...
\centering
	\includegraphics[width=\textwidth]{ACE_distance.png}
	\caption{ ACE distance in GSE Coordinates\label{ACE distance}}
\end{subfigure}
\begin{subfigure}{0.45\textwidth}
\centering
	\includegraphics[width=\textwidth]{ACE_Solarwindspeed.png}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{ACE_magneticfield.png}
